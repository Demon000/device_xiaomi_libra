...
// XIAOMI START: use local SensorManager.h
...
// XIAOMI START: this is our fake package name as required by the new API
...
status_t SensorManager::assertStateLocked() const {
    if (mSensorServer == NULL) {
        ...
        // XIAOMI START: use static asBinder interface
        IInterface::asBinder(mSensorServer)->linkToDeath(mDeathObserver);
        // XIAOMI END

        // XIAOMI START: add package name argument
...
sp<SensorEventQueue> SensorManager::createEventQueue()
{
    ...
    while (assertStateLocked() == NO_ERROR) {
        // XIAOMI START: add new required parameters
